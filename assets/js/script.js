...
var typed = new Typed(".typing-text", {
    strings: ["Data engineering", "Data development ", "Python development", "Scala development", "Data analytics", "Data science", "ETL development","Cloud development"],
    loop: true,
    typeSpeed: 40,
    backSpeed: 40,
    backDelay: 650,
...
document.getElementById('trigger-box').addEventListener('click', function() {
...
document.getElementById('trigger-box2').addEventListener('click', function() {
  var displayBox = document.getElementById('display-box2');
  // Toggle the visibility of the display box
